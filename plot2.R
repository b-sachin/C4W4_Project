...
rd <- subset(NEI, fips == "24510", c("Emissions","year"))
head(rd)
...
rdpf <- barplot(rdp, main = "Total Emission of PM2.5 in the Baltimore City from 1999 to 2008", xlab = "Years", ylab = "Total PM2.5 Emission (in tons)", col = 2:5)
